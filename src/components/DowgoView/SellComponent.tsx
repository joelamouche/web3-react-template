...
export const SellComponent=(sellDowgo:()=>void,sellInput:BigNumber,
setSellInput:SetStateFunction<BigNumber>,price:BigNumber,dowgoBalance:BigNumber)=>{

    return (<Card>
        <Card.Header>SELL</Card.Header>
        <Card.Body>
        {sellInput.mul(ONE_UNIT).gt(dowgoBalance)&& <Alert key={'warning'} variant={'warning'}>
      You don't have enough Dowgo tokens to sell.</Alert>}
